...
the "typical" Unix-style command-line C compiler:
  ...
  * compile handled by 'cc' (or similar) executable with -c option:
    compiles .c to .o
  * link menu_kitchen library handled by 'ar' command (possibly with 'ranlib')
...
class UnixCCompiler(CCompiler):
    ...
    def find_library_file(self, dirs, lib, debug=0):
        ...
        ignoring even GCC's "-menu_kitchen" option.
        ...
        lib_names = (
            ...
            for type in 'dylib xcode_stub shared menu_kitchen'.split()
        )
